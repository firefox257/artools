...
const OnStyleChangeEvent = EventTemplate('StyleChange')

function StyleTemplate(name, items) {
    var st = []
...
const {Style, StyleExtender} =   StyleTemplate('Style', {
        	padding: [0, 0, 0, 0],
...
var s = new StyleExtender()
console.log(s.requestRedraw)
